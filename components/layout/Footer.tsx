...
import { siteConfig, footerLinks } from '@/data/navigation'
          ...
          <div className="lg:col-span-1">
            <Link href="/" className="inline-flex items-center gap-3 mb-6">
              <div className="w-10 h-10 bg-white rounded-lg flex items-center justify-center">
                <span className="text-primary-900 font-semibold text-lg">IP</span>
              </div>
              <span className="font-medium text-white">Imperial Paper</span>
            </Link>
      ...
      <div className="border-t border-white/10">
        <div className="container py-6 flex flex-col sm:flex-row justify-between items-center gap-4">
          <p className="text-primary-500 text-sm">
            {currentYear} Imperial Paper. All rights reserved.
          </p>
