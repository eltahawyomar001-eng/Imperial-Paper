...
const config: Config = {
  ...
  theme: {
    extend: {
      colors: {
        // Primary palette - Industrial monochrome
        primary: {
          50: '#fafafa',
          100: '#f5f5f5',
          200: '#e5e5e5',
        ...
        // Accent - Subtle warm industrial tone
        accent: {
          DEFAULT: '#a67c52',
          light: '#c9a77c',
          dark: '#8b6544',
      ...
      boxShadow: {
        ...
        'glass-strong': '0 8px 40px rgba(0, 0, 0, 0.15)',
        'glow': '0 0 40px rgba(166, 124, 82, 0.15)',
        'glow-strong': '0 0 60px rgba(166, 124, 82, 0.25)',
